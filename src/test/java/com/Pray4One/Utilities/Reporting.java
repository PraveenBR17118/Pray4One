...
public class Reporting extends TestListenerAdapter
{
    ...
    public void onStart(ITestContext testContext)
    {
        ...
        htmlReporter.config().setDocumentTitle("Pray4One"); // Tile of report
        htmlReporter.config().setReportName("Integration1 Test Automation Report"); // name of the report
    ...
    public void onTestFailure(ITestResult tr)
    {
        ...
        if(re)
        {
            try
            {
                ...
                logger.fail("Screenshot is below").addScreenCaptureFromPath("./Screenshots");
            }
            catch (Exception e)
            {
                e.printStackTrace();
